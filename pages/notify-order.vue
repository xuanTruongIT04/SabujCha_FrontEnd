  ...
  <div>
    ...
    >
      <div class="section-head">
        ...
        <p>Cảm ơn quý khách đã đặt hàng tại hệ thống <b>SabujCha Shop</b>!</p>
        <p>
          Nhân viên chăm sóc <b>SabujCha Shop</b> sẽ liên hệ tới bạn sớm nhất có
          thể.
        </p>
      </div>
    ...
    >
      <div class="section-head">
        ...
        <p style="margin-bottom: 6px">
          <b>SabujCha Shop</b> rất hân hạnh khi được phục vụ quý khách
        </p>
